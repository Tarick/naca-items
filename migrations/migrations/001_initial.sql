...
insert into item_status (type) values('new');
insert into item_status (type) values('ready');
insert into item_status (type) values('disabled');
...
create table items (
  ...
  status TEXT NOT NULL REFERENCES item_status(type),
